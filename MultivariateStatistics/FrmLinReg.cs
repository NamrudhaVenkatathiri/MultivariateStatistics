...
{
    public partial class FrmLinReg : Form
    {
        private static FrmLinReg instance = null;

        public static FrmLinReg Instance
        {
            get { return instance; }
            set { instance = value; }
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (intX >= 0 && intY >= 0)
            {
                FrmMain.Instance.GetLinearRegression(intX, intY);
                FrmMain.Instance.Refresh();
                FrmLinReg.instance.Close();
            }
        }
